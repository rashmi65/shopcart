...
<div class="banner-bootom-w3-agileits">
	...
	<?php
	     ...
	     <div class="col-md-4 single-right-left ">
			<div class="grid images_3_of_2">
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="images/d2.jpg" style="list-style-type: none;">
							<div class="thumb-image"> <img src="<?php echo base_url(); ?>images/<?php echo $product['picture']?>" data-imagezoom="true" class="img-responsive"> </div>
						</li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
					...
					<p><span class="item_price">&#x24;<?php echo $product['price']; ?></span> <del>- $900</del></p>
					<div class="rating1">
