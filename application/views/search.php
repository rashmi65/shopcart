...
<div class="page-head_agile_info_w3l">
  ...
  <!-- banner-bootom-w3-agileits -->
						...
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Ethnic Wear</label>
								<ul>
									...
									<li><a href="<?php echo site_url('welcome/women')?>">Caps</a></li>
									<li><a href="<?php echo site_url('welcome/women')?>">Shoes</a></li>
									<li><a href="<?php echo site_url('welcome/women')?>">Pants</a></li>
									<li><a href="<?php echo site_url('welcome/women')?>">SunGlasses</a></li>
									<li><a href="<?php echo site_url('welcome/women')?>">Trousers</a></li>
								</ul>
							</li>
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						...
						<li>
							<img class="img-responsive" src="<?php echo base_url(); ?>images/banner3.jpg" alt=" "/>
						</li>
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?php echo base_url(); ?>images/<?php echo $row['picture']?>" alt="" class="pro-image-front">
										<img src="<?php echo base_url(); ?>images/<?php echo $row['picture']?>" alt="" class="pro-image-back">
									...
									<div class="item-info-product ">
										<h4><a href="<?php echo site_url('welcome/single')?>"><?php echo $row['name']?></a></h4>
										<div class="info-product-price">
											...
											<del>$189.71</del>
															...
															<?php
					echo form_open('cart1/addingwomen');
	...
	<?php } ?>
<!-- //womens 1 div --></div><div class="clearfix"></div>
