						...
						<ul>
							<li><input type="checkbox" id="item-0-0" /><label for="item-0-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>Ethnic Wear</label>
								<ul>
									...
									<li><a href="<?php echo site_url('welcome/men')?>">Caps</a></li>
									<li><a href="<?php echo site_url('welcome/men')?>">Shoes</a></li>
									<li><a href="<?php echo site_url('welcome/men')?>">Pants</a></li>
									<li><a href="<?php echo site_url('welcome/men')?>">SunGlasses</a></li>
									<li><a href="<?php echo site_url('welcome/men')?>">Trousers</a></li>
								</ul>
							</li>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						...
						<li>
							<img class="img-responsive" src="<?php echo base_url(); ?>images/banner5.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="<?php echo base_url(); ?>images/bb2.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="<?php echo base_url(); ?>images/<?php echo $product['picture']?>" alt="" class="pro-image-front" name="picture">
										<img src="<?php echo base_url(); ?>images/<?php echo $product['picture']?>" alt="" class="pro-image-back" name="picture">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="<?php echo base_url()?>index.php/product/get_men/<?php echo $id;?>" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
									...
									<div class="item-info-product ">
										<h4><a href="<?php echo site_url('welcome/index5')?>"><?php echo $name; ?></a></h4>
										<div class="info-product-price">
											...
											<del>$189.71</del>
															...
															<?php
					echo form_open('cart1/addingmen');
		 ...
		 <?php } elseif($i==3){	?>
			<div class="col-md-4 product-men">
				...
				</div><div class="clearfix"></div><div class="single-pro">
		 <?php } else{ ?>
